/**
 * An example script that handles adding/updating and run a groovy script via the REST API.
 */
...
ScriptResultXO resultXO = scripts.run(name, "")

println("Script result: ")
println(resultXO.result)